 ...
 * The type Beauty.
 */
public class Beauty extends SwipeBackActivity {
     ...
     * The Url.
     */
    String url = "http://studev.groept.be/api/a16_sd306/SearchCate/BEAUTY";
    /**
     * The Recycler view.
     */
    ...
    /**
     * The Adapter to adpter fragment to Activity
     */
    MyRecyclerAdapter adapter;

    /**
     * show the items of category Beauty
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView.addOnItemTouchListener(
                new RecyclerItemClickListener(Beauty.this, recyclerView, new RecyclerItemClickListener.OnItemClickListener() {
                    @Override
                    public void onItemClick(View view, int position) {
                        NewsFeeds currentitem = feedsList.get(position);

                        Intent intent = new Intent(Beauty.this, Detail.class);

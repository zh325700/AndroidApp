 ...
 * The type Bikes.
 */
public class Bikes extends SwipeBackActivity {
     ...
     * The Url.
     */
    String url = "http://studev.groept.be/api/a16_sd306/SearchCate/BIKES";
    /**
     * The Recycler view.
     */
    ...
    /**
     * show the items of category Bikes
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView.addOnItemTouchListener(
                new RecyclerItemClickListener(Bikes.this, recyclerView, new RecyclerItemClickListener.OnItemClickListener() {
                    @Override
                    public void onItemClick(View view, int position) {
                        NewsFeeds currentitem = feedsList.get(position);

                        Intent intent = new Intent(Bikes.this, Detail.class);

package be.kuleuven.softdev.hehuang.pokepelican.Location;
/**
 ...
 * The type Antwerpen.
 */
public class Antwerpen extends SwipeBackActivity {
     ...
     * The Url.
     */
    String url = "http://studev.groept.be/api/a16_sd306/SearchLocation/Antwerpen";
    /**
     * The Recycler view.
     */
    ...
    /**
     * show the itmes in Antwerpen in recyclerview
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView.addOnItemTouchListener(
                new RecyclerItemClickListener(Antwerpen.this, recyclerView, new RecyclerItemClickListener.OnItemClickListener() {
                    @Override
                    public void onItemClick(View view, int position) {
                        NewsFeeds currentitem = feedsList.get(position);

                        Intent intent = new Intent(Antwerpen.this, Detail.class);

 ...
 * The type Leuven.
 */
public class Leuven extends SwipeBackActivity {
     ...
     * The Url.
     */
    String url = "http://studev.groept.be/api/a16_sd306/SearchLocation/Leuven";
    /**
     * The Recycler view.
     */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView.addOnItemTouchListener(
                new RecyclerItemClickListener(Leuven.this, recyclerView, new RecyclerItemClickListener.OnItemClickListener() {
                    @Override
                    public void onItemClick(View view, int position) {
                        NewsFeeds currentitem = feedsList.get(position);

                        Intent intent = new Intent(Leuven.this, Detail.class);

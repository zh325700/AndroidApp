 ...
 * The type Brussel.
 */
public class Brussel extends SwipeBackActivity {
     ...
     * The Url.
     */
    String url = "http://studev.groept.be/api/a16_sd306/SearchLocation/Brussel";
    /**
     * The Recycler view.
     */
    ...
    /**
     * show the itmes in Brussel in recyclerview
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView.addOnItemTouchListener(
                new RecyclerItemClickListener(Brussel.this, recyclerView, new RecyclerItemClickListener.OnItemClickListener() {
                    @Override
                    public void onItemClick(View view, int position) {
                        NewsFeeds currentitem = feedsList.get(position);

                        Intent intent = new Intent(Brussel.this, Detail.class);

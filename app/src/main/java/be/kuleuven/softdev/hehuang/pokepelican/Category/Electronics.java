 ...
 */
public class Electronics extends SwipeBackActivity {
     ...
     * The Url.
     */
    String url = "http://studev.groept.be/api/a16_sd306/SearchCate/ELECTRONICS";
    /**
     * The Recycler view.
     */
    ...
    /**
     * show the items of category Electronics
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView.addOnItemTouchListener(
                new RecyclerItemClickListener(Electronics.this, recyclerView, new RecyclerItemClickListener.OnItemClickListener() {
                    @Override
                    public void onItemClick(View view, int position) {
                        NewsFeeds currentitem = feedsList.get(position);

                        Intent intent = new Intent(Electronics.this, Detail.class);
